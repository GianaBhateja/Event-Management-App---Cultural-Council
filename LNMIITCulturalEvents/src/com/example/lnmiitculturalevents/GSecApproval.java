...
public class GSecApproval extends Activity {
    ...
    private static final String url_update_product = "http://172.22.102.92/android_connect/update_product_gsec.php";
   ...
   // private static final String TAG_DESCRIPTION = "Description";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.gsec_approve_event);
     ...
     // save button click event
        ...
        class GetProductDetails extends AsyncTask<String, String, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                pDialog = new ProgressDialog(GSecApproval.this);
